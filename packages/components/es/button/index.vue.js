import { computed, openBlock, createElementBlock, normalizeClass, unref, withModifiers, createBlock, createCommentVNode, renderSlot } from "vue";
  ...
  setup(__props, { emit: emits }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("button", {
        class: normalizeClass(["text-sm text-center rounded duration-150 flex justify-center items-center", [
          typeEnum[__props.type],
          sizeEnum[unref(sizeKey)].button,
          {
            "active:scale-105": __props.isActiveAnim
          }
        ]]),
        onClick: withModifiers(onBtnClick, ["stop"])
      }, [
        ...
        __props.icon ? (openBlock(), createBlock(_sfc_main$1, {
          key: 1,
          name: __props.icon,
          class: normalizeClass(["m-auto", sizeEnum[unref(sizeKey)].icon]),
          color: __props.iconColor,
          fillClass: __props.iconClass
        }, null, 8, ["name", "class", "color", "fillClass"])) : renderSlot(_ctx.$slots, "default", { key: 2 })
      ], 10, _hoisted_1);
    };
  }
};
